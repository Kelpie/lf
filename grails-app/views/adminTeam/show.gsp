			...
			<ol class="property-list team">
				...
				<li class="fieldcontain">
					<span id="coach-label" class="property-label"><g:message code="team.coach.label" default="Coach" /></span>
						...
						<span class="property-value" aria-labelledby="coach-label"><g:link controller="player" action="show" id="${teamInstance?.coach?.id}">${teamInstance?.coach?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="logo-label" class="property-label"><g:message code="team.logo.label" default="Logo" /></span>
						...
						<span class="property-value" aria-labelledby="logo-label"><g:fieldValue bean="${teamInstance}" field="logo"/></span>
